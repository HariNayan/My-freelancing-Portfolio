    ...
    <section id="services" className="py-16 md:py-24 xl:py-32 bg-neutral-950 px-6">
      <div className="container mx-auto max-w-6xl">
        <Reveal className="text-center mb-12 md:mb-16">
          <Eyebrow index="02" label="Services" center />
          <h2 className="text-3xl md:text-3xl xl:text-4xl font-display font-bold text-white mt-4 mb-4">Services</h2>
        ...
        <Stagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {SERVICES.map((service) => {
            const Icon = service.icon;
            return (
              <Item key={service.id} className="h-full">
                <div
                  className="h-full bg-neutral-900 p-6 md:p-8 rounded-xl border border-neutral-800 hover:border-neutral-600 hover:-translate-y-1 transition-all duration-300 group hover:shadow-lg hover:shadow-white/5"
                >
